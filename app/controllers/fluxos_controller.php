 ...
 *
 * app/controllers/fluxos_controller.php
 *
...
class FluxosController extends AppController {
	...
	{
		$solicitacoes 	= $this->Fluxo->Solicitacao->find('list');
		$contatos		= $this->Fluxo->Contato->find('list');
		$this->set(compact('solicitacoes','contatos'));
