 ...
 *
 * app/controllers/regras_solicitacoes_departamentos_controller.php
 *
 ...
 * @since CPWeb V3
 */
class RegrasSolicitacoesDepartamentosController extends AppController {
	/**
	 * Nome
	 * 
	 * @var string
	 * @access public
	 */
	public $name = 'RegrasSolicitacoesDepartamentos';
	 ...
	 * @access public
	 */
	public $uses = 'RegraSolicitacaoDepartamento';
	...
	{
		$solicitacoes = $this->RegraSolicitacaoDepartamento->Solicitacao->find('list');
		$this->loadModel('Departamento');
		$departamentos = $this->Departamento->find('list');
		$this->set(compact('departamentos','solicitacoes'));
	}
